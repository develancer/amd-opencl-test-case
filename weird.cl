...
void secp256k1_fe_from_storage(secp256k1_fe *r, __constant const secp256k1_fe_storage *a) {
...
void secp256k1_fe_get_b32(__global unsigned char *r, const secp256k1_fe *a) {
  r[0] = (a->n[9] >> 14) & 0xff;
  r[1] = (a->n[9] >> 6) & 0xff;
...
void secp256k1_ge_from_storage(secp256k1_ge *r, __constant const secp256k1_ge_storage *a) {
...
__constant secp256k1_ge_storage prec[512] = {
...
__kernel void weird(__global uchar* result) {
